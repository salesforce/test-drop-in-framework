 ...
 */
public class EnhancedEventFiringKeyboard implements Keyboard {
	private final WebDriver driver;
//	private final EnhancedWebDriverEventListener dispatcher;
	private final Keyboard keyboard;

	public EnhancedEventFiringKeyboard(WebDriver driver, EnhancedWebDriverEventListener dispatcher) {
		this.driver = driver;
